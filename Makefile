# argo-stac-eo-pipeline — local ladder control surface
#
...
#   make seed               # seed the logbook with deliberate gaps
...
.DEFAULT_GOAL := help
.PHONY: help check up down ui browse status seed demo clean reset build rebuild _check-stage
...
seed: ## Seed the logbook with two missions + deliberate gaps
