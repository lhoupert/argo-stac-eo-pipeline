...
> it knows what should exist, finds what's missing, and fills exactly that.
...
`src/eo_ingest/ingest.py` is byte-identical to its rung-1 form — enforced by `scripts/check_shared_logic.py` in CI.
