"""The frozen unit of work — resolve -> download -> register (gated on STAC_URL).

This is the byte-stable core. Tests exercise it against the real synthetic source, moto S3,
