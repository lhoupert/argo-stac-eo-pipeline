"""The `eo_ingest.list_gaps` CLI: emit a collection's missing days as JSON.

This is the seam between `find_gaps` and Argo's dynamic fan-out: the rung-3 workflow runs
