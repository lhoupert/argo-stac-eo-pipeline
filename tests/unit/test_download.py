...
def test_earthsearch_fetches_remote_asset_into_sink_and_rewrites_href() -> None:
    # A real asset is fetched from its remote href, stored in MinIO, and the item's href is
