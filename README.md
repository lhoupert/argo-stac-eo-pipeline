...
**A. Dev container / Codespace (zero host setup).** The
...
a GitHub Codespace *should* let you skip everything below. See
[Dev container / Codespaces](#dev-container--codespaces).

> [!NOTE]
> Verified on a **host install (B)** and the **local dev container** ("Reopen in Container").
> GitHub Codespaces *should* work too but isn't tested yet; if it misbehaves, fall back to either.
